...
1. Read [COURSE_GUIDE.md](COURSE_GUIDE.md).
2. Review [ROADMAP.md](ROADMAP.md).
3. Set your routine with [STUDY_PLAN.md](STUDY_PLAN.md).
4. Open [Week 1](Weeks/Week-01/README.md).
5. Begin [Day 1](Weeks/Week-01/Days/Day-01.md).
6. Record every completed task in [PROGRESS_TRACKER.md](PROGRESS_TRACKER.md).
...
- Goethe-focused exam preparation plus telc A1 and ÖSD A1 orientation
...
| Activity | Minutes |
|---|---:|
| Review and active recall | 10 |
| Vocabulary | 20 |
| Pronunciation and shadowing | 15 |
| Grammar and sentence patterns | 25 |
| Reading and listening | 20 |
| Speaking and writing | 20 |
| Exercises and correction | 10 |
| **Total** | **120** |

## Course rule

Do not study only grammar. Every day includes listening, speaking, reading and writing because A1 is a communication level, not a collection of definitions.
...
The vocabulary collection is built from a Goethe-aligned A1 source deck and original course-created additions. The source-deck material is attributed in [ATTRIBUTION.md](ATTRIBUTION.md) and distributed under CC BY-SA 4.0.
